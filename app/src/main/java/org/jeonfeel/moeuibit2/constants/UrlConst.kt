...
object UrlConst {
    ...
    const val UPBIT_SOCKET_BASE_URL = "api.upbit.com"
    const val UPBIT_SOCKET_PATH = "/websocket/v1"

    const val BITHUMB_BASE_URL = "https://api.bithumb.com/"
    const val BITHUMB_SOCKET_BASE_URL = "api.bithumb.com"
    const val BITHUMB_SOCKET_PATH = "/websocket/v1"
